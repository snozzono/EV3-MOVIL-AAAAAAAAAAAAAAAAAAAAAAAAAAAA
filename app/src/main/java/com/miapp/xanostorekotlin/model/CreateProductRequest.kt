...
data class CreateProductRequest(
    ...
    // Habilitado por defecto: asegura que los productos nuevos aparezcan activos (estrella verde).
    // Si el backend ignora el campo, no afecta; si lo acepta, el producto queda habilitado.
