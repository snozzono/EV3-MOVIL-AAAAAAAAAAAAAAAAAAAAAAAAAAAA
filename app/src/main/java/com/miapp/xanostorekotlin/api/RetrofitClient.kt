...
object RetrofitClient { // Objeto singleton que expone métodos de fábrica
    ...
    // NUEVO: Fábrica para CartService (usa storeBaseUrl y Authorization)
    ...
    // NUEVO: Fábrica para OrderService (orders, order_item, shipping)
    ...
    // NUEVO: Fábrica para UserService (listar/actualizar usuarios)
    // Usamos storeBaseUrl porque tus endpoints CRUD de "user" están en ese grupo.
